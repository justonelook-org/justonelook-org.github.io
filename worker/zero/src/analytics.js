...
export async function readMetrics(database, from, to) {
  ...
  return {
    ...
    note: "These figures measure delivery of the invitation and conversational reports of trying. Not reporting an attempt does not mean the inward look did not occur."
  };
}
