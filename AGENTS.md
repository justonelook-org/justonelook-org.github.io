...
- `try-it/x/`, `try-it/bluesky/`, `try-it/reddit/`, `try-it/tiktok/`, `try-it/tumblr/`, and `try-it/pinterest/` are the social source-entry routes currently published for Zero.
