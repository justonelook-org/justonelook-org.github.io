...
Zero's canonical public webpages are `/try-it/` for Look At Yourself and `/self-directed-attention/` for the Self-Directed Attention Exercise. The published social source-entry routes are `/try-it/x/` and `/try-it/bluesky/`.
